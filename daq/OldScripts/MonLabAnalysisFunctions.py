...
def GetFileList(DataPath,Date,FibreType,FibreLength,LEDWavelength,Voltage,RunNumber):
    ...
    #         LEDWavelength = 405
    #         Run = 2
    if(RunNumber==0): FilePaths = str(DataPath)+str(Date)+'_hv'+str(Voltage)+'_'+str(FibreLength)+'m_'+str(FibreType)+'_LED'+str(LEDWavelength)+'nm_measure32'+'*.npy'
    else: FilePaths = str(DataPath)+str(Date)+'_hv'+str(Voltage)+'_'+str(FibreLength)+'m_'+str(FibreType)+'_LED'+str(LEDWavelength)+'nm_measure_night_'+str(RunNumber)+'_'+'*.npy'
