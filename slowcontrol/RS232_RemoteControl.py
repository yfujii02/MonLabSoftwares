# -*- coding: utf-8 -*-
"""
Created on Thurs 25/11/2021
Author: Sam Dekkers

Run this if the voltage has already been left on to take data
"""
import sys
print(sys.path)
...
ResetFlag = 0 #Not good to reset until sure
